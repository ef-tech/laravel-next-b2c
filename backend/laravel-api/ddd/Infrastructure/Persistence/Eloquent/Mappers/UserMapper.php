...
final class UserMapper
{
    ...
    public function toModel(User $entity, EloquentUser $model): void
    {
        ...
        // Set default password for new users (required for authentication)
        // This is a temporary solution until Password is added to the domain model
        if ($isNewUser && empty($model->password)) {
