...
- [ ] 1. 設定ファイルとミドルウェア基盤を構築する
- [ ] 1.1 バージョン管理設定ファイルを作成する
...
- [ ] 2. 既存コントローラーをV1ディレクトリに移行する
- [ ] 2.1 ヘルスチェック機能をV1ディレクトリに移行する
...
- [ ] 3. DDD Infrastructure層のV1 Presenter/Requestを実装する
- [ ] 3.1 V1 Presenterを実装する
...
- [ ] 4. V1ルーティングファイルを作成し、既存ルートと統合する
- [ ] 4.1 V1ルーティングファイルを作成する
