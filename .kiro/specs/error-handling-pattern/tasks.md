...
- [ ] 1. エラーコード体系とリソース構造を設計する
- [ ] 1.1 エラーコード定義ファイルを作成する
...
- [ ] 3. ミドルウェアスタックを拡張する
- [ ] 3.1 Accept-Languageヘッダー解析ミドルウェアを実装する
...
- [ ] 14.2 カバレッジレポートをCodecovに統合する
  - Backend Unit Tests（90%閾値）のカバレッジレポート統合を実装する
  - Backend Feature Tests（85%閾値）のカバレッジレポート統合を実装する
  - Frontend Unit Tests（80%閾値）のカバレッジレポート統合を実装する
  - カバレッジ閾値未達時のCI/CD失敗設定を実装する
  - Pull Requestマージブロック設定を実装する
